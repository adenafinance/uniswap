...
contract AdenaERC20 {
    ...
    string public constant name = 'Adena LP Token';
    string public constant symbol = 'ADENA-LP';
    ...
    function permit(address owner, address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) external {
        require(deadline >= block.timestamp, 'AdenaFinance: EXPIRED');
        ...
        require(recoveredAddress != address(0) && recoveredAddress == owner, 'AdenaFinance: INVALID_SIGNATURE');
